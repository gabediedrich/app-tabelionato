...
# rom django.core.validators import MaxValueValidator, validate_comma_separated_integer_list
...
class MultiChoiceQuestion(Question):
    ...
    def get_answers_list(self):
        return [
            ...
            for answer in self.randomize_order(Answer.objects.filter(question=self))
        ]
...
class TrueFalseQuestion(Question):
    ...
    def __str__(self):
        return [{"content": self.content, "answer": self.is_correct}]
...
class Answer(models.Model):
    ...
    question = models.ForeignKey(
        Question, verbose_name=_("Questão"), on_delete=models.CASCADE
    )
